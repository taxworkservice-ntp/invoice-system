          ...
          {isBillingNote && document.vat_registered ? (
            ...
            <table className="print-classic-items-table">
              <colgroup>
                <col style={{ width: "12mm" }} />
                <col
                  style={{ width: hideDeliveryAmounts ? "139mm" : "80mm" }}
                />
                ...
                <tr>
                  ...
                  {!hideDeliveryAmounts && (
                    <>
                      ...
                      <th style={{ textAlign: "center" }}>
                        ส่วนลด<span className="en">DISC.</span>
                      </th>
                      <th style={{ textAlign: "right" }}>
                    ...
                    if (isDnHeader) {
                      ...
                      return (
                        <tr key={item.id} className="print-classic-dn-header-row">
                          ...
                          <td colSpan={hideDeliveryAmounts ? 3 : 5} className="print-classic-dn-header-label">
