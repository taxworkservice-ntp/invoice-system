...
export const CLIENT_FEATURES: {
  ...
  },
  {
    ...
    description:
      "แสดงตัวเลือกแนบภาคผนวกรายละเอียดการส่งของในหน้าออกใบแจงหนี้จากใบส่งของ เมื่อเปิดใช้ ใบแจ้งหนี้จะแสดงรายการแบบกระชับ และแนบตารางเปรียบเทียบ ส่งแล้ว vs เรียกเก็บ ตามใบส่งของท้ายเอกสาร",
  },
  {
    key: "payroll",
    label: "Payroll",
    description:
      "จัดการข้อมูลพนักงานและคำนวณเงินเดือน รวม OT เงินเพิ่ม และการหัก",
  },
];
